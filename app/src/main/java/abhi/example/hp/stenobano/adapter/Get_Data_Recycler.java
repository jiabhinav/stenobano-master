...
import abhi.example.hp.stenobano.user.Long_Play_View_Speed_Test;

/**
 * Created by hp on 9/29/2017.
 */

public class Get_Data_Recycler extends RecyclerView.Adapter<Get_Data_Recycler.HolderItem> implements Filterable {
    ...
    public Get_Data_Recycler(List<Search_Model> mlistItem, Context context,AlertDialogInterFace alertDialogInterFace) {
    ...
    public void onBindViewHolder(HolderItem holder, final int position) {
        ...
        pid = model.getId();
        if (checkExistValue(model.getImage()))
        {
                ...
                for (int i = 0; i < userModelArrayList.size(); i++) {
                    if (userModelArrayList.get(i).getId().equals(pid)) {
                        ...
                        if (model.getType().equals("short_speed"))
                        {
                            ...
                            get( audio_name,image_name,image_name2,holder.progressBar2,holder.text_download,holder.status,holder.rl_download);
                            //getImage(image_name);
                            //Toast.makeText(context, "return is "+re, Toast.LENGTH_SHORT).show();
    ...
    //==============================================================================================
    private void get(String audio_name,String image1,String image2,ProgressBar progressBar2,TextView text_download,TextView status,RelativeLayout rl_download) {
                                    ...
                                    if (response != null) {
                                        ...
                                        try {
                                            ...
                                            while ((count = input.read(data)) != -1) {
                                                ...
                                                Log.d("ddsdwddqdd",progress+"");
                                                //progressBar2.setProgress(progress);
                                               // text_download.setText(progress+"%");
                                                output.write(data, 0, count);
                                            }
                                            ...
                                            if (type.equals("short_speed")) {
                                                getImage(image1,status,progressBar2,text_download);
                                            } else {
                                                getAduioTwo(audio_name, image1, image2,text_download,progressBar2,text_download);
                                            }
    ...
    private void getAduioTwo(String audio_name,String image1,String image2,TextView status,ProgressBar progressBar,TextView text_progress)
    {
                            ...
                            if (response!=null) {
                                ...
                                try{
                                   ...
                                   // progressBar.setProgress(100);
                                    ...
                                    getImage(image2,status,progressBar,text_progress);
                                               /* db = new DatabaseHandler(context);
                                                Helper_Model helper_model=new Helper_Model();
                                                helper_model.setImage(image_name);
                                                helper_model.setImage_two(image_name2);
    ...
    //==========================================
    private void getImage(String image,TextView status,ProgressBar progressBar,TextView text_progres)
    {
