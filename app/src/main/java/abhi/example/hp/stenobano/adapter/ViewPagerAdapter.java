...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    List<ModelCategoryDetail.Image> userModelArrayList;

    public ViewPagerAdapter(Context context , List<ModelCategoryDetail.Image> userModelArrayList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        Log.d("dwdwdwdwdd",userModelArrayList.get(position).getName());
        Picasso.with(context)
                .load(BaseUrl.IMAGE_URL+userModelArrayList.get(position).getName())
