package abhi.example.hp.stenobano.chat.Audio;
...
import abhi.example.hp.stenobano.chat.GroupChat_Fragmnet;
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                ...
                                Adduser_to_inbox.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        GroupChat_Fragmnet.SendPushNotification(new SesssionManager(context).getToken(), BaseUrl.STENO_TOKEN);
