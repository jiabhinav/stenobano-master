...
import abhi.example.hp.stenobano.adapter.OfflineAudioPlay_Adapter;
...
public class PlayOfflineAudioImage extends AppCompatActivity  implements Player.EventListener,SetSpeed, View.OnClickListener {
    private PlaybackStateListener playbackStateListener;
    List<Helper_Model> model;
    List<Helper_Model> model2;
...
*/
        ...
        OfflineAudioPlay_Adapter adapter=new OfflineAudioPlay_Adapter(model,this,this);
...
//======================
    public void Set_Player(final int currentPage) {
        p=p+1;
        final Helper_Model item = model.get(currentPage);
        //=====================================================
        ...
        File file = getApplicationContext().getFileStreamPath(item.getListAudio().get(0).getAudio());
        String filePath = file.getAbsolutePath();
        //MediaSource mediaSource = buildMediaSource(BaseUrl.IMAGE_URL +item.getListAudio().get(0).getAudio());
       ...
       float speed= Float.parseFloat(new SesssionManager(PlayOfflineAudioImage.this).getSpeed());
            ...
            switch (playbackState) {
                ...
                case ExoPlayer.STATE_ENDED:
                    ...
                    if (default_play.equals("next"))
                    {
                        ...
                        if (model.size() >= p)
                        {
                            Toast.makeText(PlayOfflineAudioImage.this, "Next", Toast.LENGTH_SHORT).show();
                            layoutManager.scrollToPositionWithOffset(p, 0);
                        }
    ...
    public void Release_Privious_Player() {
        if (privious_player != null) {
            privious_player.removeListener(PlayOfflineAudioImage.this);
    ...
    private void speed_option_menu() {
        ...
        PlaySpeedAdpater adpater = new PlaySpeedAdpater(speed_list, this, current_speed);
    ...
    {
        current_speed=speed;
        new SesssionManager(PlayOfflineAudioImage.this).setSpeed(String.valueOf(speed));
        PlaybackParameters playbackParameters = new PlaybackParameters(current_speed, 1.0F);
        player.setPlaybackParameters(playbackParameters);
       ...
       // if (new SesssionManager(PlayAudioImage.this).getDefaultPlay().equals("repeat"))
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                {
                    default_play="next";
                    new SesssionManager(PlayOfflineAudioImage.this).setPlay(default_play);
                    Toast.makeText(PlayOfflineAudioImage.this, "Next", Toast.LENGTH_SHORT).show();
                }
               ...
               else if (i==R.id.once)
                {
                    default_play="once";
                    new SesssionManager(PlayOfflineAudioImage.this).setPlay(default_play);
                    Toast.makeText(PlayOfflineAudioImage.this, "once", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    default_play="repeat";
                    new SesssionManager(PlayOfflineAudioImage.this).setPlay(default_play);
                    Toast.makeText(PlayOfflineAudioImage.this, "Repeat", Toast.LENGTH_SHORT).show();
                }
