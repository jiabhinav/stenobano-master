...
public class Play_Audio_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play_speed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(Play_Audio_Details.this);
                ...
                seekBar2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "First play the music!", Toast.LENGTH_SHORT).show();
                        }
                    }
